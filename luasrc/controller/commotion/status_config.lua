...
function index()
	...
	local page  = node("admin", "status", "commotion")
	page.target = template("status-olsr/overview")
	page.title  = _("OLSR")
	page.subindex = true

	local page  = node("admin", "status", "commotion", "nearby_md")
	page.target = call("action_neigh")
	page.title  = _("Neighbours")
	page.subindex = true
	page.order  = 5

	local page  = node("admin", "status", "commotion", "routes")
	page.target = call("action_routes")
	page.title  = _("Routes")
	page.order  = 10

	local page  = node("admin", "status", "commotion", "topology")
	page.target = call("action_topology")
	page.title  = _("Topology")
	page.order  = 20

	local page  = node("admin", "status", "commotion", "hna")
	page.target = call("action_hna")
	page.title  = _("HNA")
	page.order  = 30

	local page  = node("admin", "status", "commotion", "mid")
	page.target = call("action_mid")
	page.title  = _("MID")
	page.order  = 50

	local page  = node("admin", "status", "commotion", "smartgw")
	page.target = call("action_smartgw")
	page.title  = _("SmartGW")
	page.order  = 60

	local page  = node("admin", "status", "commotion", "interfaces")
